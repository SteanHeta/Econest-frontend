...
const ShareTipCard = () => {
    ...
    return (
        <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
            ...
            {submitted && (
                <p className="mt-4 text-sm text-green-600 font-medium">Thank you for your tip!</p>
            )}
        </div>
    );
};
